          ...
          <article id="courts" className="info-block index-article bordered">
            <article>
              ...
              <p>
                ...
                tennisintresserade vuxna möjlighet att lära sig tennisspelet,
                allt efter egen förmåga och intresse. I vuxenträningen kommer du
                att lära dig och förbättra de olika tennisslagen samt lära dig
                spelregler i singel- och dubbelspel. Varje person ska få
                möjlighet att under ett träningspass få individuell instruktion
                utifrån sina behov. Vuxentennisens grupper indelas i största
                möjliga mån för att vara så jämspelta som möjligt. Till
                vuxentennis hör även lunchtennis och frukosttennis.
              </p>
            </article>
            <p>
          ...
          <article id="equipment" className="info-block index-article bordered">
            <article>
              ...
              <p>
                ...
                elit. Consequuntur modi praesentium quisquam, nemo voluptate
                quam autem libero accusantium reprehenderit odio necessitatibus
                quis nesciunt soluta dolor laudantium harum nostrum iusto
                placeat.
              </p>
              <p>
                Vi erbjuder även bastu - då exercitationem voluptatum sunt
                fugiat perferendis enim cum molestias veritatis quas
                consequuntur ut ex, sed hic facilis nostrum vel? Lorem, ipsum
